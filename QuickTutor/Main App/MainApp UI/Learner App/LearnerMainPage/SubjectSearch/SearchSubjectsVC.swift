...
class SearchSubjectsVC: BaseViewController {
...
extension SearchSubjectsVC: UITableViewDelegate, UITableViewDataSource {
...
extension SearchSubjectsVC: DidSelectSubcategoryCell {
    func didSelectSubcategoryCell(resource _: String?, subcategory: String) {
        let next = TutorConnectVC()
...
extension SearchSubjectsVC: UISearchBarDelegate {
