...
class LearnerFiltersVC: BaseViewController {
...
extension LearnerFiltersVC: CLLocationManagerDelegate {
...
extension LearnerFiltersVC: UITableViewDelegate, UITableViewDataSource {
