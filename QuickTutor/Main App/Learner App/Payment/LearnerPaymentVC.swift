...
class LearnerPaymentVC: BaseViewController {
    ...
    @objc func textFieldsValid(_: UITextField) {
    ...
    private func nextButtonPressed() {
        if !flipped {
            ...
            StripeService.attachSource(cusID: CurrentUser.shared.learner.customer, adding: card, completion: { response in
...
extension LearnerPaymentVC: UITextFieldDelegate {
