...
//    }
    ...
    func setupAvailabilityLabel() {
        ...
        availabilityLabel.anchor(top: hourSliderView.bottomAnchor, left: leftAnchor, bottom: nil, right: rightAnchor, paddingTop: 60, paddingLeft: 30, paddingBottom: 0, paddingRight: 30, width: 0, height: 18)
    }
