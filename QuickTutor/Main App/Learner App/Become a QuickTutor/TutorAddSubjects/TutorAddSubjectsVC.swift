...
class TutorAddSubjectsVC: BaseViewController {
...
extension TutorAddSubjectsVC: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        if tableView.tag == 1 {
            ...
            tableView.deselectRow(at: indexPath, animated: true)
            contentView.nextButton.label.text = "Next (\(selected.count))"
        }
    }
...
extension TutorAddSubjectsVC: DidSelectSubcategoryCell {
...
extension TutorAddSubjectsVC: UISearchBarDelegate {
