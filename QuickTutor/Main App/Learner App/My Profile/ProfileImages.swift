...
class ProfileImageScrollPopOver : BaseViewController {
	...
	override func viewDidLoad() {
		...
		self.horizontalScrollView.contentSize = CGSize(width:self.horizontalScrollView.frame.size.width * 4,height: self.horizontalScrollView.frame.size.height)
	...
	func configurePageControl() {
		...
		self.pageControl.currentPageIndicatorTintColor = Colors.learnerPurple
