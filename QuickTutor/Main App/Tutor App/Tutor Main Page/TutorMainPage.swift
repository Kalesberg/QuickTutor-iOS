...
extension TutorMainPage : UITableViewDelegate, UITableViewDataSource {
	...
	func numberOfSections(in tableView: UITableView) -> Int {
		return TutorMainPageCellFactory.tutorMainPageCells.count
	}

	func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
		let cell = tableView.cellForRow(at: indexPath) as! TutorMainPageTableViewCell
		cell.growSemiShrink {
			let viewController = TutorMainPageCellFactory.tutorMainPageCells[indexPath.section].viewController
	...
	func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
		...
		cell.title.text = TutorMainPageCellFactory.tutorMainPageCells[indexPath.section].mainPageCell.title
		cell.subtitle.text = TutorMainPageCellFactory.tutorMainPageCells[indexPath.section].mainPageCell.subtitle
		return cell
	}
}
extension TutorMainPage : UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
	func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
		return TutorMainPageButtonFactory.tutorMainPageButtons.count
	}
	...
	func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
		...
		cell.imageView.image = TutorMainPageButtonFactory.tutorMainPageButtons[indexPath.item].mainPageButton.icon
		cell.backgroundColor = TutorMainPageButtonFactory.tutorMainPageButtons[indexPath.item].mainPageButton.color
		cell.label.text = TutorMainPageButtonFactory.tutorMainPageButtons[indexPath.item].mainPageButton.label
		cell.label.textColor = TutorMainPageButtonFactory.tutorMainPageButtons[indexPath.item].mainPageButton.color
	...
	func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
		...
		cell.growSemiShrink {
			let viewController = TutorMainPageButtonFactory.tutorMainPageButtons[indexPath.item].viewController
			self.navigationController?.pushViewController(viewController, animated: true)
		}
