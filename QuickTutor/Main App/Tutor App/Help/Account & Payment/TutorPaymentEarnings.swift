...
class TutorPaymentEarningsView: PaymentOptionsView {
    override func configureView() {
        ...
        gratuityBody.text = "You are allowed to ask for tips as a tutor. However, being tip is not required and any aggressive behavior regarding tipping will not be tolerated. Giving a tip is completely optional. Tips are added to the total of your earnings and are still topic to the QuickTutor service fee ($2.00 + 10% of the total)."
    }
}
