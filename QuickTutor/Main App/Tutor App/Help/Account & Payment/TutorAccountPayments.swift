...
extension TutorAccountPayments : UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        case 1:
            self.navigationController?.pushViewController(TutorUpdatePayment(), animated: true)
        case 2:
            self.navigationController?.pushViewController(TutorPaymentEarnings(), animated: true)
        case 3:
