...
class EditProfileView : MainLayoutTitleBackSaveButton, Keyboardable {
...
class EditProfile : BaseViewController {
	
	override var contentView: EditProfileView {
...
extension EditProfile : UIScrollViewDelegate {
...
extension EditProfile : UIImagePickerControllerDelegate, UINavigationControllerDelegate, AACircleCropViewControllerDelegate {
