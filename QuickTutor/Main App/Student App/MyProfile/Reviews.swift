...
class ReviewsView : MainLayoutTitleBackButton {
...
class Reviews : BaseViewController {
    
    override var contentView: ReviewsView {
        return view as! ReviewsView
    }
    var reviews = ["1", "2", "4"]
...
extension Reviews : UITableViewDelegate, UITableViewDataSource {
