...
class FileReportView : MainLayoutHeader {
...
class FileReport : BaseViewController {
    
    override var contentView: FileReportView {
        return view as! FileReportView
    }
...
extension FileReport : UITableViewDelegate, UITableViewDataSource {
