//
//  QTLearnerAddInterestsViewController.swift
//  QuickTutor
//
...
class QTLearnerAddInterestsViewController: UIViewController {
    ...
    let contentView: QTLearnerAddInterestsView = {
        let view = QTLearnerAddInterestsView()
        return view
    }()
...
extension QTLearnerAddInterestsViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
...
extension QTLearnerAddInterestsViewController: CustomSearchBarDelegate {
...
extension QTLearnerAddInterestsViewController: UITextFieldDelegate {
...
extension QTLearnerAddInterestsViewController: UIScrollViewDelegate {
...
extension QTLearnerAddInterestsViewController: QuickSearchCategoryCellDelegate {
