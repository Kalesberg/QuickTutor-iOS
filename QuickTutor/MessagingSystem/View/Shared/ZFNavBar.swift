...
extension CustomNavBarDisplayer where Self: UIViewController {
    func addNavBar() {
        ...
        navBar.anchor(top: nil, left: view.leftAnchor, bottom: view.safeAreaLayoutGuide.topAnchor, right: view.rightAnchor, paddingTop: 0, paddingLeft: 0, paddingBottom: -70, paddingRight: 0, width: 0, height: 150)
    }
